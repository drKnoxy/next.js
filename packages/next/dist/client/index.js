...
var _router2 = require("next-server/dist/lib/router");
...
var asset = _interopRequireWildcard(require("next-server/asset"));
  ...
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 22:
          exports.router = router = (0, _router2.createRouter)(page, nextExport ? (0, _utils.getQuery)() : query, asPath, {
            initialProps: props,
