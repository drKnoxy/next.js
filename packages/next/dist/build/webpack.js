...
var _assetsSizePlugin = _interopRequireDefault(require("./webpack/plugins/assets-size-plugin"));
...
function externalsConfig(dir, isServer, lambdas) {
  ...
  var notExternalModules = ['next/app', 'next/document', 'next/error', 'http-status', 'string-hash'];
...
function optimizationConfig(_ref) {
  var dir = _ref.dir,
      ...
      lambdas = _ref.lambdas;
  var terserPluginConfig = {
    parallel: true,
    sourceMap: false,
    cache: true,
    cacheKeys: function cacheKeys(keys) {
  ...
  if (isServer && lambdas) {
    return {
      splitChunks: false,
      minimizer: [new _terserWebpackPlugin.default(terserPluginConfig)]
    };
  }
  ...
  config.minimizer = [new _terserWebpackPlugin.default(terserPluginConfig)]; // Only enabled in production
...
function _getBaseWebpackConfig() {
  ...
  _regenerator.default.mark(function _callee3(dir, _ref2) {
    var _ref2$dev, dev, _ref2$isServer, isServer, buildId, config, _ref2$lambdas, lambdas, defaultLoaders, nodePathList, distDir, outputPath, pagesEntries, totalPages, clientEntries, resolveConfig, webpackMode, webpackConfig, originalEntry;

    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _ref2$dev = _ref2.dev, dev = _ref2$dev === void 0 ? false : _ref2$dev, _ref2$isServer = _ref2.isServer, isServer = _ref2$isServer === void 0 ? false : _ref2$isServer, buildId = _ref2.buildId, config = _ref2.config, _ref2$lambdas = _ref2.lambdas, lambdas = _ref2$lambdas === void 0 ? false : _ref2$lambdas;
            defaultLoaders = {
              babel: {
            ...
            return (0, _utils.getPages)(dir, {
              nextPagesDir: _constants2.DEFAULT_PAGES_DIR,
              dev: dev,
              buildId: buildId,
              isServer: isServer,
          ...
          case 7:
            ...
            clientEntries = !isServer ? (0, _defineProperty2.default)({
              ...
              'main.js': []
            }, _constants.CLIENT_STATIC_FILES_RUNTIME_MAIN, [_path.default.join(_constants2.NEXT_PROJECT_ROOT_DIST, 'client', dev ? "next-dev" : 'next')].filter(Boolean)) : {};
            resolveConfig = {
              // Disable .mjs for node_modules bundling
              extensions: ['.wasm', !lambdas && '.mjs', '.js', '.jsx', '.json'].filter(Boolean),
              modules: [_constants2.NEXT_PROJECT_ROOT_NODE_MODULES, 'node_modules'].concat((0, _toConsumableArray2.default)(nodePathList)),
              alias: {
            ...
            webpackConfig = {
              ...
              resolveLoader: {
                modules: [_constants2.NEXT_PROJECT_ROOT_NODE_MODULES, 'node_modules', _path.default.join(__dirname, 'webpack', 'loaders')].concat((0, _toConsumableArray2.default)(nodePathList))
              },
              module: {
                rules: [dev && !isServer && {
              ...
              new _chunkNamesPlugin.default(), !isServer && new _reactLoadablePlugin.ReactLoadablePlugin({
                ...
                name: isServer ? 'server' : 'client'
              }), dev && !isServer && new _friendlyErrorsWebpackPlugin.default(), // Even though require.cache is server only we have to clear assets from both compilations
              ...
              !dev && new _webpack.default.HashedModuleIdsPlugin(), // Removes server/client code by minifier
              ...
              }), !isServer && !dev && new _assetsSizePlugin.default({
                buildId: buildId,
                distDir: distDir
              })].filter(Boolean)
            };
